                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Selling services involves identifying market needs, positioning your expertise to address them, and delivering value through effective communication and execution.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Rental services offer temporary access to goods or property in exchange for a fee, providing flexibility and convenience without the commitment of ownership.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Property listing refers to the process of advertising real estate for sale or rent, typically through various mediums such as online platforms, or real estate agencies.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Legal investment refers to the act of allocating funds into financial instruments or ventures that comply with applicable laws and regulations.</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Quality refers to the degree of excellence or superiority of a service, or process, often measured against predefined standards or expectations. It encompasses aspects such as reliability, durability, efficiency, and customer satisfaction, reflecting the overall value provided.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Security involves protecting systems, data, and individuals from unauthorized access, misuse, or harm through measures such as encryption, authentication, and monitoring, ensuring confidentiality, integrity, and availability of resources. It encompasses various domains including cybersecurity, physical security, and risk management to mitigate potential threats and vulnerabilities.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Services are intangible offerings provided by businesses to fulfill specific needs or tasks for customers, ranging from professional expertise to tangible outcomes. They encompass a wide array of industries, including healthcare, finance, consulting, hospitality, and more, often tailored to meet individual preferences and requirements.</p>
									</div>
                                </li>
                            </ul>
                        </div>
